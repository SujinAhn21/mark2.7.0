...
# STEP 4: 메인 학습 함수 수정
# 함수 전체적으로 수정
def train_student_with_distillation(seed_value=42, mark_version="mark2.7.0"):
    set_seed(seed_value)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--mark_version', type=str, default="mark2.7.0", help="The model version to use.")
